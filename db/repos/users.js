...
var Repository = (function () {
    function Repository(db, pgp) {
        ...
        this.profile = function (nickname) {
            return _this.db.oneOrNone(sql.profile, { nickname: nickname }, function (userProf) {
                if (userProf === null) {
